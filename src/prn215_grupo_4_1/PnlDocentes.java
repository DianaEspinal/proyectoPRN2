...
import funciones.funciones_docente;
...
public class PnlDocentes extends javax.swing.JPanel {
    ...
    Docente controlador_docente = new Docente();
    funciones_docente funciones = new funciones_docente();
    ...
    public PnlDocentes() {
        ...
        cmbMateria.setModel(funciones.llenarMateria());
        ...
        tbDocentes.getTableHeader().setOpaque(false);
        tbDocentes.getTableHeader().setBackground(new Color(183, 35, 95));
        tbDocentes.getTableHeader().setForeground(Color.WHITE);
        tbDocentes.getTableHeader().setFont(new Font ("Dialog", Font.BOLD, 15));
        tbDocentes.setFont(new Font ("Dialog", Font.PLAIN, 12));
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos de docente", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(204, 204, 204))); // NOI18N
        ...
        lblCodGrado.setText("Materia a enseñar:");
    ...
    private void tbDocentesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDocentesMouseClicked
        ...
        try {
            ...
            int fila = tbDocentes.getSelectedRow();
            String codigoEstudiante = tbDocentes.getValueAt(fila, 0).toString();
            
            ps = conn.prepareStatement("SELECT docentes.idDocente, personas.nombres, personas.apellidos, materias.idMateria, materias.nombreMateria, personas.telefono, personas.direccion, personas.correoElectronico, personas.fechaRegistro\n" +
                                    "FROM docente docentes\n" +
                                    "INNER JOIN persona personas ON personas.idPersona = docentes.idDocente\n" +
                                    "INNER JOIN materia materias ON materias.idMateria = docentes.idMateria\n" +
                                    "WHERE docentes.idDocente = ?" +
                                    "GROUP BY docentes.idDocente;");
            ...
            while (rs.next()) 
            {
                ...
                cmbMateria.setSelectedItem(rs.getString("nombreMateria"));
    ...
    {          
        ...
        try 
        {
            ...
            String sql = "SELECT docentes.idDocente, personas.nombres, personas.apellidos, materias.idMateria, materias.nombreMateria, personas.telefono, personas.direccion, personas.correoElectronico, personas.fechaRegistro\n" +
                        "FROM docente docentes\n" +
                        "INNER JOIN persona personas ON personas.idPersona = docentes.idDocente\n" +
                        "INNER JOIN materia materias ON materias.idMateria = docentes.idMateria\n" +
                        "GROUP BY docentes.idDocente;"; 
        ...
        tbDocentes.getColumnModel().getColumn(0).setMinWidth(0);
        tbDocentes.getColumnModel().getColumn(0).setMaxWidth(0);
        tbDocentes.getColumnModel().getColumn(3).setMinWidth(0);
        tbDocentes.getColumnModel().getColumn(3).setMaxWidth(0);
    ...
    private void agregarDocente()
    {
        ...
        if (txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtTelefono.getText().isEmpty()
           ...
           || cmbPersona.getSelectedIndex() == -1 || cmbMateria.getSelectedIndex() == -1) 
        {
        ...
        else
        {
            ...
            controlador_docente.setIdDocente(idPersona);
            String idMateria = funciones.getIdMateria(cmbMateria.getSelectedItem().toString());
            int idMateriaInt = Integer.parseInt(idMateria);
            controlador_docente.setIdMateria(idMateriaInt);
            
            
            //System.out.print(idPersona);
            //System.out.print(idMateriaInt);
            
            funciones.agregarDocente(controlador_docente);
    ...
    private void actualizarDocente()
    {
        ...
        else
        {
            ...
            int fila = tbDocentes.getSelectedRow();
            int idDocente = Integer.parseInt(tbDocentes.getValueAt(fila, 0).toString());
            controlador_docente.setIdDocente(idDocente);
            String idMateria = funciones.getIdMateria(cmbMateria.getSelectedItem().toString());
            int idMateriaInt = Integer.parseInt(idMateria);
            controlador_docente.setIdMateria(idMateriaInt);
            ...
            funciones.actualizarDocente(controlador_docente);
        }
    }
    ...
    private void eliminarDocente()
    {
        ...
        if (respuesta == JOptionPane.YES_OPTION) 
        {
            ...
            int idDocente = Integer.parseInt(tbDocentes.getValueAt(fila, 0).toString());
            controlador_docente.setIdDocente(idDocente);
            funciones.eliminarDocente(controlador_docente);
